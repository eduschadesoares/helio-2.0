...
class HelicopterGenerator:
    def generate_random_helicopters(self, quantity, all_dest):
        helicopters = []
        ...
        for _ in range(quantity):
            ...
            current_city = random.choice(all_dest)

            flight_hours = random.randint(100, 10000)
            age = random.randint(1, 10)

            # Crie uma instância de Helicopter com os valores gerados
            helicopter = Helicopter(serial, current_city.get('city'), flight_hours, age)
